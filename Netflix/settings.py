...
SECRET_KEY = 'django-insecure-y^@&8&_o+u-4c%*--1x5w2=x95z*gg7b##+hw2*!gh-wxv^nt*'
...
AUTHENTICATION_BACKENDS = ['django.contrib.auth.backends.ModelBackend',                 # Needed to login by username in Django admin, regardless of `allauth`
